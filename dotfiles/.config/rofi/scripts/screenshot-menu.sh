...
FULLSCREEN_INSTANT=" Fullscreen (instant)"
...
CHOICE=$(echo -e "$OPTIONS" | rofi -dmenu -i -p "Screenshots ($SCREENSHOT_DIR)" -theme ~/.config/rofi/config.rasi -theme-str "entry { enabled: false; }")
